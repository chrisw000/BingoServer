...
CREATE DATABASE [BigCheese]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BigCheese', FILENAME = N'/var/opt/mssql/data/BigCheese.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BigCheese_log', FILENAME = N'/var/opt/mssql/data/BigCheese_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
